...
//g++ SphereLighting.cpp sphere_gen.cpp readBMP.cpp shader.cpp -g -I /home/mathew/SelfStudy/glm -lGLESv2 -lglfw -lm -o lighting
...
int main(int argc, char* argv[]) {
    ...
    // 11) Pass the vertex & texure coordinates BO
